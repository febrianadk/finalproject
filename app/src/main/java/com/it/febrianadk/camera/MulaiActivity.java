...
public class MulaiActivity extends AppCompatActivity {
    ...
    public void callCamera(){
        ...
        Intent captureIntent = new Intent(MulaiActivity.this, CameraActivity.class);
        ...
        try {
            ...
            if (requestCode == RESULT_CROP ) {
                if(resultCode == Activity.RESULT_OK){
                    ...
                    alertText.setText("");
                    resultText.setText("Go Check Your Iris..");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(MulaiActivity.this,MainActivity.class);
        startActivity(back);
    }
